    ...
    try:
        with open('/home/pi/rocket-buds/sensor_measurements/' + get_curr_time() + ".txt", mode="w") as file:
            ...
            while True:
                ...
                camera.capture(os.path.join(os.path.expanduser('~'), 'capture', time_curr + '.jpg'),
                                format='jpeg', use_video_port=False, resize=None, quality=85, thumbnail=False, bayer=False,)
